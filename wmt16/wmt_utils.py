...
_TRAIN_SUBSETS = [
    ...
    SubDataset(
        ...
        url="https://hf-mirror.com/datasets/wmt/wmt13/resolve/main-zip/training-parallel-commoncrawl.zip",
    ...
    SubDataset(
        ...
        sources={"fr"},
        url=(
            "https://hf-mirror.com/datasets/wmt/wmt19/resolve/main/translation-task/fr-de/bitexts/commoncrawl.fr.gz",
            "https://hf-mirror.com/datasets/wmt/wmt19/resolve/main/translation-task/fr-de/bitexts/commoncrawl.de.gz",
        ),
        path=("", ""),
    ),
    SubDataset(
    ...
    SubDataset(
        ...
        target="en",
        sources={"lv"},
        url="https://hf-mirror.com/datasets/wmt/wmt17/resolve/main-zip/translation-task/dcep.lv-en.v1.zip",
    ...
    SubDataset(
        ...
        target="en",
        sources={"cs", "de", "es", "fr"},
        url="https://hf-mirror.com/datasets/wmt/wmt13/resolve/main-zip/training-parallel-europarl-v7.zip",
    ...
    SubDataset(
        ...
        sources={"fr"},
        url=(
            "https://hf-mirror.com/datasets/wmt/wmt19/resolve/main/translation-task/fr-de/bitexts/europarl-v7.fr.gz",
            "https://hf-mirror.com/datasets/wmt/wmt19/resolve/main/translation-task/fr-de/bitexts/europarl-v7.de.gz",
        ),
        path=("", ""),
    ),
    SubDataset(
        ...
        target="en",
        sources={"et", "fi"},
        url="https://hf-mirror.com/datasets/wmt/wmt18/resolve/main-zip/translation-task/training-parallel-ep-v8.zip",
    ...
    SubDataset(
        ...
        target="en",
        sources={"fi", "ro"},
        url="https://hf-mirror.com/datasets/wmt/wmt16/resolve/main-zip/translation-task/training-parallel-ep-v8.zip",
    ...
    SubDataset(
        ...
        target="en",
        sources={"cs", "de", "fi", "lt"},
        url="https://hf-mirror.com/datasets/wmt/europarl/resolve/main/v9/training/europarl-v9.{src}-en.tsv.gz",
        path="",
    ),
    SubDataset(
        name="gigafren",
        target="en",
        sources={"fr"},
        url="https://hf-mirror.com/datasets/wmt/wmt10/resolve/main-zip/training-giga-fren.zip",
    ...
    SubDataset(
        ...
        target="en",
        sources={"lv"},
        url="https://hf-mirror.com/datasets/wmt/wmt17/resolve/main-zip/translation-task/leta.v1.zip",
    ...
    SubDataset(
        ...
        target="en",
        sources={"es", "fr"},
        url="https://hf-mirror.com/datasets/wmt/wmt13/resolve/main-zip/training-parallel-un.zip",
    ...
    SubDataset(
        ...
        target="en",
        sources={"cs", "de", "fr", "ru"},
        url="https://hf-mirror.com/datasets/wmt/wmt14/resolve/main-zip/training-parallel-nc-v9.zip",
    ...
    SubDataset(
        ...
        target="en",
        sources={"cs", "de", "fr", "ru"},
        url="https://hf-mirror.com/datasets/wmt/wmt15/resolve/main-zip/training-parallel-nc-v10.zip",
    ...
    SubDataset(
        ...
        target="en",
        sources={"cs", "de", "ru"},
        url="https://hf-mirror.com/datasets/wmt/wmt16/resolve/main-zip/translation-task/training-parallel-nc-v11.zip",
        path=(
    ...
    SubDataset(
        ...
        target="en",
        sources={"cs", "de", "ru", "zh"},
        url="https://hf-mirror.com/datasets/wmt/wmt17/resolve/main-zip/translation-task/training-parallel-nc-v12.zip",
    ...
    SubDataset(
        ...
        target="en",
        sources={"cs", "de", "ru", "zh"},
        url="https://hf-mirror.com/datasets/wmt/wmt18/resolve/main-zip/translation-task/training-parallel-nc-v13.zip",
        path=(
    ...
    SubDataset(
        ...
        target="en",
        sources={"lv"},
        url="https://hf-mirror.com/datasets/wmt/wmt17/resolve/main-zip/translation-task/books.lv-en.v1.zip",
    ...
    SubDataset(
        ...
        sources={"fr"},
        url=(
            "https://hf-mirror.com/datasets/wmt/wmt19/resolve/main/translation-task/fr-de/bitexts/de-fr.bicleaner07.de.gz",
            "https://hf-mirror.com/datasets/wmt/wmt19/resolve/main/translation-task/fr-de/bitexts/de-fr.bicleaner07.fr.gz",
        ),
        path=("", ""),
    ),
    SubDataset(
        ...
        target="en",
        sources={"de", "et", "fi"},
        url="https://hf-mirror.com/datasets/wmt/wmt18/resolve/main-zip/translation-task/rapid2016.zip",
    ...
    SubDataset(
        ...
        target="en",
        sources={"ru", "zh"},
        url="https://hf-mirror.com/datasets/wmt/uncorpus/resolve/main-zip/UNv1.0.en-{src}.zip",
    ...
    SubDataset(
        ...
        target="en",
        sources={"fi"},
        url="https://hf-mirror.com/datasets/wmt/wmt15/resolve/main-zip/wiki-titles.zip",
    ...
    SubDataset(
        ...
        target="en",
        sources={"hi"},
        url="https://hf-mirror.com/datasets/wmt/wmt14/resolve/main-zip/wiki-titles.zip",
    ...
    SubDataset(
        ...
        url="https://hf-mirror.com/datasets/wmt/wikititles/resolve/main/v1/wikititles-v1.{src}-en.tsv.gz",
        path="",
    ),
    SubDataset(
        name="yandexcorpus",
    ...
    SubDataset(  # pylint:disable=g-complex-comprehension
        ...
        target="en",
        sources={"zh"},
        url="https://hf-mirror.com/datasets/wmt/wmt18/resolve/main/cwmt-wmt/%s.zip" % ss,
...
_DEV_SUBSETS = [
    SubDataset(
        ...
        target="de",
        sources={"fr"},
        url="https://hf-mirror.com/datasets/wmt/wmt19/resolve/main-zip/translation-task/dev.zip",
