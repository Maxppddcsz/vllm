...
HF_ENDPOINT=https://hf-mirror.com python benchmark/benchmark_noprefix_translation.py \
...
from benchmark.trace import generate_translation_requests_noprefix
...
def main(args: argparse.Namespace):
    ...
    # Generate requests.
    requests = generate_translation_requests_noprefix(
        model=args.model,
